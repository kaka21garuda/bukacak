...
class SkillViewController: UIViewController {
    ...
    func addCircle() {
        ...
        oneCircle.animate(duration: 2.0, completion: 0.55, color: UIColor(red: 23 / 255.0, green: 168 / 255.0, blue: (248 / 255.0), alpha: 1.0).cgColor)
        twoCircle.animate(duration: 2.0, completion: 1.0, color: UIColor(red: 254 / 255.0, green: 139 / 255.0, blue: 58 / 255.0, alpha: 1.0).cgColor)
        threeCircle.animate(duration: 2.0, completion: 0.65, color: UIColor(red: 51 / 255.0, green: 51 / 255.0, blue: 51 / 255.0, alpha: 1.0).cgColor)
        fourCircle.animate(duration: 2.0, completion: 0.80, color: UIColor(red: 79 / 255.0, green: 221 / 255.0, blue: 121 / 255.0, alpha: 1.0).cgColor)
    }
